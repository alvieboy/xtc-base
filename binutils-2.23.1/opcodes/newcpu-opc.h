...
{ 
    ...
    {"add",   INST_TYPE_R1_R2, INST_NO_OFFSET, NO_DELAY_SLOT, IMMVAL_MASK_NON_SPECIAL, 0x1200, OPCODE_MASK_ARITH, addc, arithmetic_inst },
    {"add",   INST_TYPE_R1_R2, INST_NO_OFFSET, NO_DELAY_SLOT, IMMVAL_MASK_NON_SPECIAL, 0x1400, OPCODE_MASK_ARITH, sub, arithmetic_inst },
