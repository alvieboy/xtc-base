...
} opcodes[] =
{
    ...
    {"rusr", NO_EXT, NO_IMM, INST_TYPE_R1_R2, 0x3D00, OPCODE_MASK_ARITH, INST_NO_OFFSET, rusr },
    {"wusr", NO_EXT, NO_IMM, INST_TYPE_R1_R2, 0x3F00, OPCODE_MASK_ARITH, INST_NO_OFFSET, wusr },
